-- Full Database Setup Script for ITECH3108_30438140_a2
-- Run the following as the postgres superuser from the terminal:
-- psql -U postgres -f setup.sql

-- CREATE DATABASE & USER

CREATE DATABASE "ITECH3108_30438140_a2";
CREATE USER itech3108 WITH LOGIN PASSWORD 'itech3108pass';
GRANT ALL PRIVILEGES ON DATABASE "ITECH3108_30438140_a2" TO itech3108;
-- CONNECT TO DATABASE

\c ITECH3108_30438140_a2

-- Grant schema-level permissions (required in PostgreSQL 15+)
GRANT ALL ON SCHEMA public TO itech3108;
...
-- Grant table and sequence permissions to itech3108
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO itech3108;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO itech3108;
...
(
    3, 2,
    'Have you guys seen Runway Gen-2!',
...
(2, 1, TRUE),
(2, 3, FALSE),
-- Post 3 (ChatGPT) — liked by pixel_kai and dreamer_lux
(3, 2, TRUE),
(3, 3, TRUE),
...
FROM posts
JOIN users      ON posts.post_id  = posts.post_id
